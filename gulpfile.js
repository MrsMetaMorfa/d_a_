...
const srcBase = "src/",
  ...
  paths = {
    ...
    js: {
      ...
      srcExternal: srcBase + "js/external/**/*",
      dest: destBase + "assets/js/",
    },
    // images are in build/assets/img/*
    img: {
      src: srcBase + "assets/img/**/*.{png,gif,jpg,bmp,tiff,jpeg,webp,svg}",
      dest: destBase + "assets/img/"
    },
    // other ("data") files are copied recursively to build/assets/
    fonts: {
      src: srcBase + "assets/fonts/*",
      dest: destBase + "assets/fonts/"
    }
};
...
function copyFonts() {
  return gulp.src(paths.fonts.src, {since: gulp.lastRun(copyFonts)})
...
function watchFonts() {
  return gulp.watch(`${srcBase}fonts/**/*`, copyFonts);
}
...
exports.build = gulp.parallel(css, jsMain, jsExternal, html, images, copyFonts);

exports.watch = gulp.parallel(watchCss, watchJsMain, watchJsExternal, watchHtml, watchFonts);
